                ...
                <div className="flex h-16 items-center justify-between">
                  <div className="flex items-center">
                    <div className="flex-shrink-0">
                      <h1 className="tracking-widest text-base text-white uppercase">Next Supabase Template</h1>
                    </div>
        ...
        <main>
          <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            ...
            <div className="px-4 py-4 sm:px-0">
              <div className="h-96">
                <p>
                  This will be a good starting point with any of your applications. This application is bootstrapped
                  with Nextjs, Clerk for Authentication, and Supabase.
                </p>
              </div>
            </div>
            {/* /End replace */}
